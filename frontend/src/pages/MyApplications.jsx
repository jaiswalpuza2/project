    ...
    <div className="space-y-10">
      <div className="max-w-6xl mx-auto">
        ...
        {loading ? (
                ...
                <div className="flex flex-col md:flex-row items-stretch">
                  ...
                  <div className="p-8 flex-1">
                    <div className="flex justify-between items-start mb-6">
                      ...
                      <span className="text-xs font-black text-slate-400 dark:text-slate-500 uppercase tracking-widest transition-colors">
          ...
          <div className="bg-white dark:bg-[#1E293B] shadow-xl dark:shadow-black/20 rounded-[3rem] border-2 border-dashed border-slate-200 dark:border-slate-600 py-32 text-center transition-colors">
            <div className="h-20 w-20 bg-slate-50 dark:bg-[#0F172A] rounded-full flex items-center justify-center mx-auto mb-6 border border-slate-200 dark:border-slate-600 transition-colors">
              <FileText className="text-slate-400 dark:text-slate-500" size={32} />
            </div>
            <h3 className="text-2xl font-bold text-slate-900 dark:text-slate-200 transition-colors">No applications yet</h3>
            <p className="text-slate-500 dark:text-slate-400 mt-2 transition-colors">Start showcasing your skills by applying to jobs!</p>
