  ...
  return (
    <div className="space-y-12">
      <div className="max-w-7xl mx-auto">
        <header className="mb-6 text-center transition-all">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-black text-slate-900 dark:text-white mb-3 tracking-tight transition-colors">Find Your Next <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-cyan-600 dark:from-indigo-400 dark:to-cyan-400">Greatness</span></h1>
          <p className="text-slate-500 dark:text-slate-400 max-w-2xl mx-auto text-base font-medium transition-colors">
            Join 10,000+ top freelancers and get matched with elite employers worldwide.
          </p>
        </header>
        <div className="glass bg-white/80 dark:bg-slate-800/80 p-6 rounded-[2.5rem] mb-6 flex flex-col lg:flex-row gap-4 items-center border border-slate-200 dark:border-slate-600 shadow-xl dark:shadow-slate-950/50 transition-colors">
                ...
                <div key={job._id} className="group/card relative">
                  <Link to={`/jobs/${job._id}`} className="block h-full">
                    <div className="bg-white dark:bg-[#1E293B] shadow-xl dark:shadow-[0_20px_50px_-12px_rgba(0,0,0,0.5)] p-8 rounded-[3rem] border border-slate-100 dark:border-slate-600 hover:border-indigo-600/30 dark:hover:border-indigo-400/50 transition-all duration-500 h-full flex flex-col hover:shadow-indigo-500/10 dark:hover:shadow-[0_20px_50px_-12px_rgba(79,70,229,0.2)] hover:-translate-y-2 group transition-colors">
                      ...
                      <div className="mb-8">
                        <h3 className="text-xl md:text-2xl font-black text-slate-900 dark:text-[#E2E8F0] group-hover:text-indigo-600 dark:group-hover:text-white transition tracking-tight mb-2 leading-tight transition-colors">
                          {job.title}
                        </h3>
                        <div className="flex items-center gap-3 text-slate-600 dark:text-[#CBD5E1] text-base font-black transition-colors">
